...
- [METHOD.md](https://github.com/rahulnakmol/skills/blob/main/skills/developer/sdlc/METHOD.md) describes the SPEC-TS ledger — Scope, Product requirements, Engineering constraints, Components, Trade-offs, and Success metrics — and the modes of interaction a user can expect.
