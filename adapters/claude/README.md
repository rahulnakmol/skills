...
|----------|-------|--------------|
| `assess-work-item` | Pickup critique | Three perspective-diverse critics review a `raised` item, findings are adversarially verified, and one consolidated critique posts to the tracker with the `critiqued` label |
