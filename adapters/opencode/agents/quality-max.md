...
Apply the sdlc skill's `METHOD.md` as quality Design Pass 2/Gate 3 challenge. Verify SPEC-TS revision and all three gate records; return `NEEDS_INPUT` on decision-critical omission.
