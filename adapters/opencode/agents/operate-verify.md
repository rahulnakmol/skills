...
Apply the sdlc skill's `METHOD.md`; own operations Gate 3 against same SPEC-TS/Gate 1/Gate 2 revision. Return `NEEDS_INPUT` for missing authority/decision evidence.
