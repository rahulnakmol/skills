---
name: research
description: Model-invoked source investigation. Use when a question needs an answer from primary sources — official documentation, a specification, or the source code itself — and the finding should be written to a cited file in the repository so a later session reads it instead of repeating the search.
---
