...
steps:
  - skill: discover
    ...
    blurb: "Turns a raw problem or a vague opportunity into a structured, stakeholder-grounded analysis."
  - skill: carve
    title: "Carve the epics"
    blurb: "Breaks the initiative into epics, each tested against DIVE before it enters the manifest."
  - skill: case
    title: "Build the case"
    blurb: "Weighs real options against doing nothing and costs each one, including the agent fleet's own."
  - skill: report
