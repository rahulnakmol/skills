...
<div class="prompt-card">Produce the quarterly leadership pack for QuenServe epic E1 per skills/pm/report/REPORT-METHOD.md — value first, then the 4Ps, sourced from realize, raid, roadmap, and case.<button type="button" class="prompt-card-copy" aria-label="Copy this prompt">Copy</button></div>
